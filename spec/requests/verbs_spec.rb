  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Verb" do
        expect {
          post verbs_url, params: { verb: valid_attributes }
        }.to change(Verb, :count).by(1)
      end

      it "redirects to the created verb" do
        post verbs_url, params: { verb: valid_attributes }
        expect(response).to redirect_to(verb_url(Verb.last))
      end
    end

    context "with invalid parameters" do
      it "does not create a new Verb" do
        expect {
          post verbs_url, params: { verb: invalid_attributes }
        }.to change(Verb, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested verb" do
        verb = Verb.create! valid_attributes
        patch verb_url(verb), params: { verb: new_attributes }
        verb.reload
      ...
      it "redirects to the verb" do
        ...
        patch verb_url(verb), params: { verb: new_attributes }
        verb.reload
        expect(response).to redirect_to(verb_url(verb))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        verb = Verb.create! valid_attributes
        patch verb_url(verb), params: { verb: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
