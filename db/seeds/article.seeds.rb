begin
  if Article.present? and !Article.exists?
    ...
    Article.create!([
                      ...
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'plural'),
                        gender: gender = Gender.find_by(en: 'other'), kind: 'definite', de: 'die' }
                    ])
    ...
    Article.create!([
                      ...
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'plural'),
                        gender: gender = Gender.find_by(en: 'other'), kind: 'definite', de: 'den' }
                    ])
    ...
    Article.create!([
                      ...
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'plural'),
                        gender: gender = Gender.find_by(en: 'other'), kind: 'definite', de: 'der' }
                    ])
    ...
    Article.create!([
                      ...
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'plural'),
                        gender: gender = Gender.find_by(en: 'other'), kind: 'indefinite', de: 'keine' }
                    ])
    kasus = Gcase.find_by(en: 'accusative')
    Article.create!([
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'singular'),
    ...
    Article.create!([
                      ...
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'plural'),
                        gender: gender = Gender.find_by(en: 'other'), kind: 'indefinite', de: 'keinen' }
                    ])
    kasus = Gcase.find_by(en: 'genitive')
    Article.create!([
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'singular'),
                      ...
                      { part_of_speech: pos, gcase: kasus, number: number = Number.find_by(en: 'plural'),
                        gender: gender = Gender.find_by(en: 'other'), kind: 'indefinite', de: 'keiner' }
                    ])
