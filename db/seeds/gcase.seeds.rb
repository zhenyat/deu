begin
  if (Gcase.present? and not Gcase.exists?)
    Gcase.create!([
      { de: 'Nominativ (Wer-Fall)', en: 'nominative', ru: 'именительный',
      ...
      { de: 'Genitiv (Wessen-Fall)', en: 'genitive', ru: 'родительный',  
      ...
      { de: 'Dativ (Wem-Fall)', en: 'dative', ru: 'дательный',
      ...
      { de: 'Akkusativ (Wen-Fall)', en: 'accusative', ru: 'винительный',
